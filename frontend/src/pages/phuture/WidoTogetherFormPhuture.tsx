  ...
  if (isVaultQueueLoaded && vaultQueue) {
    queueElement = (
      <Box sx={{ marginTop: 2, paddingX: 1.5 }}>
        <Typography variant="subtitle2">Current batch</Typography>
        <Typography gutterBottom variant="body2">
          Execution date: next weekend
        </Typography>
        <List dense={true}>
        ...
        {txState !== "pending" && !unsupported && (
          <>
            ...
            <FormControl fullWidth sx={{ mb: 4 }}>
              ...
              <FormHelperText>{`Chain: ${chainLabel}`}</FormHelperText>
            </FormControl>
            ...
            />
            {/* <Alert severity="info">
              Ethereum network fee (Gas) for minting PDI will be evenly split
              across all batch participants.
            </Alert> */}

            {/* Your deposit transaction will be added to a batch after you Approve and Deposit. Wido will execute the batch in the next 7 days during low gas period (usually on weekends). Gas will be paid in PDI and split evenly across all batch participants. Wido does not charge any extra fees for batch transactions. Learn how it works. */}
          </>
        )}
      </DialogContent>
      <DialogActions>
